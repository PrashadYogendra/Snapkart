...
function AddGrocery() {
    ...
    const handleSubmit = async(e:FormEvent)=>{
        ...
        try{
            ...
            console.log("Grocery item added successfully:", result.data)
            setLoading(false)
        } catch (error) {
    ...
    <div className='min-h-screen flex items-center justify-center
     bg-linear-to-br from-green-50 to-white py-16 px-4 relative'>
        ...
        shadow-md hover:bg-green-100 hover:shadow-lg transition-all'>
            ...
            <p className='text-gray-500 text-sm mt-2 text-center'>Add your grocery items here.</p>
            </div>
            <form className='flex flex-col gap-6 w-full' onSubmit={handleSubmit}>
                <div>
                    <label htmlFor="name" className='block text-gray-700 font-medium mb-1'>
                        ...
                        value={name} 
                        className='w-full borderborder-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400
                        transition-all' />
                        </div>
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
                            <div className=''>
                                <label className='block text-gray-700 font-medium mb-1'>category<span className='text-red-500'>*</span>
                                </label>
                                <select name="category" className='w-full border border-gray-300 rounded-xl
                                px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all bg-white'
                            ...
                            <div>
                                <label className='block text-gray-700 font-medium mb-1'>unit<span className='text-red-500'>*</span>
                                </label>
                    ...
                    <label htmlFor="name" className='block text-gray-700 font-medium mb-1'>
                        ...
                        <input type="text" id='name' placeholder='eg: 100' 
                    ...
                    jsutify-center gap-2 bg-green-50 text-green-700 font-semibold border
                    border-green-200 rounded-xl px-6 py-3 hover:bg-green-100 transition-all w-full sm:w-auto'>
