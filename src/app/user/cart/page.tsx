...
function CartPage() {
  const { cartData, subTotal, deliveryCharges, finalTotal } = useSelector(
          ...
          <div className="lg:col-span-2 space-y-5">
            <AnimatePresence>
              {cartData.map((item, index) => (
                ...
                >
                  <div
                    className="relative w-28 h-28 sm:w-24 sm:h-24 md:w-28 md:h-28 flex-shrink-0
                  ...
                  <div className="mt-4 sm:mt-0 sm:ml-4 flex-1 text-center sm:text-left">
                    ...
                    <p className="text-sm font-bold text-green-700 mt-1 sm:text-base">
