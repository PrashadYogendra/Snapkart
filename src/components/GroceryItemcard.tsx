      ...
      <motion.div
        ...
        >
          ...
          overflow-hidden group'>
            <Image src={item.image} fill alt={item.name} sizes='(max-width:
            768px) 100vw, 25vw'
            className='object-contain p-4 transition-transform duration-500 group-hover:scale-105'/>
            <div className='absolute inset-0 bg-linear-to-t from-black/10
          ...
          <div className='p-4 flex flex-col flex-1'>
            ...
            <div className='flex items-center justify-between mt-2'>
              ...
              <span className='text-lg font-bold text-green-700 ml-2'>₹{item.price}</span>
            </div>
