...
function CategorySlider() {
  const categories = [
            ...
            { id: 9, name: "Instant & Pacakaged Food", icon: Box, color: "bg-teal-100"},
  ...
  return (
    ...
    >
      <h2 className='text-2xl md:text-3xl font-bold text-green-700 mb-6 text-center'>
        ...
        <div className='flex gap-6 overflow-x-auto px-10 pb-4 scrollbar-hided scroll-smooth' ref={scrollRef}>
          {categories.map((cat) => {
            const Icon= cat.icon
            return(
              <motion.div
