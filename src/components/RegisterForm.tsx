import { ArrowLeft, Eye, EyeIcon, EyeOff, Leaf, Loader2, Lock, LogIn, Mail, User } from 'lucide-react'
        ...
        transition={{
         ...
         className='text-4xl font-extrabold text-green-700 mb-2'>
            ...
            <p className='text-gray-600 mb-8 flex items-center'>Join snapcart today ! 
                <Leaf className='w-5 h-5 ml-2 text-green-600' /></p>
        ...
        transition={{
         ...
         className='flex flex-col gap-5 w-full max-w-sm'>
            ...
            <div className='relative'>
                ...
                <input type="text" placeholder='Username' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 focus:outline-none'
                 value={name}
            ...
            <div className='relative'>
                ...
                <input type="email" placeholder='Email' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:ring-2 focus:ring-green-500 focus:outline-none'
                 value={email}
            ...
            <div className='relative'>
             ...
             border border-gray-300 hover:bg-gray-50 py-3 rounded-xl
              text-gray-700 font-medium transition-all duration-200' onClick={()=>signIn("google",{callback:"/"})}>
             ...
             <p className='cursor-pointer flex items-center justify-center text-gray-600 mt-6 text-sm  gap-1' onClick={()=>router.push("/login")}>
                Already have an account ? <LogIn className='w-4 h-4'/> <span className='text-green-600'>Sign in</span></p>
